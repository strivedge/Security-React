            ...
            <div className='role--container mt-0 pt-0 d-block'>
                <ul className='nested-Lists'>
                    ...
                    <li>
                        ...
                        {isShownGovernanceChild && (
                            <ul className='nested-ChildLists row'>
                                <li className="col-6 col-lg-4 col-xl-3"> <label className="mb-0" title="Risk-Assessment-Method" htmlFor="Risk-Assessment-Method">Risk Assessment Method</label>
                                    <input type="checkbox" id="Risk-Assessment-Method" checked={rolePermission.governance.ram} onChange={(e) => handleChange(e, 'governance', 'ram')} className="form-check-input pointer " />
                                </li>
                                ...
                                <li className="col-6 col-lg-4 col-xl-3">
                                    <label className="mb-0" title="Compliance-Control" htmlFor="Compliance-Control">Compliance Control</label>
                                    <input type="checkbox" id="Compliance-Control" checked={rolePermission.governance.cc} onChange={(e) => handleChange(e, 'governance', 'cc')} className="form-check-input pointer " />
                                </li>
